...
public class DDGUtils {
    ...
    private static Logger logger = LoggerFactory.getLogger("org.trade.core.model.utils.DDGUtils");
    ...
    public static DataDependenceGraph unmarshalGraph(InputStream ddgGraphContent)
        ...
        if (ddgGraphContent != null) {
            ...
            InputStream xsdSchemaContent = DDGUtils.class.getResourceAsStream(ModelConstants.DDG_SCHEMA_LOCATION);
