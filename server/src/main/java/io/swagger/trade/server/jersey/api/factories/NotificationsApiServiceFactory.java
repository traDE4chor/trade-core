...
import io.swagger.trade.server.jersey.api.impl.NotificationsApiServiceImpl;
...
public class NotificationsApiServiceFactory {
    private final static NotificationsApiService service = new NotificationsApiServiceImpl();
